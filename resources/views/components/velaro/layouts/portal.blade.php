  ...
  <div>
    <header class="topbar">
      ...
      <div class="row push topbar__actions">
        ...
        <span style="display:grid;line-height:1.2"><strong style="font-size:var(--text-sm);color:#fff">{{ $reseller?->trade_name ?? auth()->user()->name }}</strong><small style="font-size:var(--text-xs);color:rgba(255,255,255,.5)">Parceiro Premium</small></span>
      </div>
    </header>
