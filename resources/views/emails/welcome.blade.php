...
@section('content')
    ...
    <p style="margin: 0 0 24px;">
        <a href="{{ route('dashboard') }}" style="display: inline-block; background: #0e5b58; color: #ffffff; text-decoration: none; padding: 10px 18px; border-radius: 999px; font-weight: 600;">
            Acessar minha conta
        </a>
    </p>
    <p style="margin: 0;">
