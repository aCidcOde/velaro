...
<html lang="pt-br">
    ...
    @php
        ...
        $emailLogoSrc = file_exists($emailLogoPath)
            ...
            : asset('logo.webp');
    @endphp
    <body style="margin: 0; padding: 0; background-color: #f3f2ef;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color: #f3f2ef; padding: 24px 0;">
            <tr>
                <td align="center">
