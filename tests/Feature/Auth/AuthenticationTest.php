...
class AuthenticationTest extends TestCase
{
    ...
    public function test_blocked_users_cannot_authenticate_using_the_login_screen(): void
    {
        ...
        $response->assertRedirect(route('login'))
            ->assertSessionHasErrors([
                'email' => User::BLOCKED_MESSAGE,
            ]);

        $this->assertGuest();
    }

    public function test_blocked_authenticated_users_are_logged_out_from_protected_routes(): void
    {
