# Notas de leitura do protótipo — campo a campo
> Registro literal do que cada tela do PDF mostra. Base para os mockups e a documentação.
...
## 1.4 CADASTRO COMO LOJISTA (p-06)
...
## 1.6 STATUS DA SOLICITAÇÃO (p-08)
...
> card do revendedor (logo, "Cód. Revendedor: 00876", "Plano: Parceiro Premium ◆") +
> card "PRECISA DE AJUDA? Fale com nosso time sempre que precisar."
> Topbar: INÍCIO · PEDIDOS · VITRINE · CLIENTES · RELATÓRIOS + usuário "Tomazelli Alianças ⌄" +
> botão "SOLICITAR ATENDIMENTO / Exclusivo para lojistas"
> Rodapé 4 selos: Qualidade premium · Confiança e garantia · Entrega para todo Brasil · Parceria que gera valor

## 2.2 CATÁLOGO REVENDEDOR (p-12)
...
## 2.6 PERSONALIZAÇÃO DA LOJA (p-16)
...
## 2.11 PEDIDO PRONTO PARA RETIRADA (p-21)
...
## 2.9 VITRINE PARA CLIENTES — painel de gestão (p-19)
...
## 2.10 CARRINHO DE COMPRAS — vitrine em tablet (p-20)
...
> Shell do Master: sidebar (Dashboard · Clientes · Configurações · Estoque · Financeiro · Pedidos · Produtos ·
> Promoções · Relatórios · Revendedores · Solicitações pré-cadastro · Suporte) + card "VELARO ADMINISTRAÇÃO ·
> Plano: Master ◆ · Ver meu plano"
> Topbar: selo "Painel Interno / Gestão de Revendedores" · busca "Buscar revendedor, pedido, cliente…" (Ctrl + K) ·
> "Acessar loja / Velaro Alianças ↗" · **botão "Painel Revendedor / Ver como revendedor"** ·
> sino com badge (3) · engrenagem · avatar "Velaro Alianças / Admin ⌄"
...
## 3.11 SOLICITAÇÕES PRÉ-CADASTRO (p-33)
