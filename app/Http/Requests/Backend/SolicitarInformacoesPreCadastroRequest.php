...
@since 2026-09-06
Valida a justificativa e a permissao para solicitar informacoes sobre um pre-cadastro de lojista.
*/
...
class SolicitarInformacoesPreCadastroRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->hasBackendPermission('velaro.prospects.request_info') === true
