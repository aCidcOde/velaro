...
@since 2026-09-06
Valida a justificativa e a permissao para aprovar um pre-cadastro de lojista.
*/
...
class AprovarPreCadastroRequest extends FormRequest
{
    public function authorize(): bool
    {
        ...
        return $this->user()?->hasBackendPermission('velaro.prospects.approve') === true
