...
class PrecosController extends Controller
{
    public function edit(): never
    {
        ...
        throw new HttpException(501, 'Tela ainda nao implementada: portal.precos.edit');
    }
    ...
    public function update(): never
    {
        // Esqueleto: a rota existe e esta no mapa, a tela ainda nao foi construida.
        // O ambiente Site publico foi implementado primeiro; este entra na sequencia.
        throw new HttpException(501, 'Tela ainda nao implementada: portal.precos.update');
    }
}
