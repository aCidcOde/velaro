...
class SuporteController extends Controller
{
    public function index(): never
    {
        ...
        throw new HttpException(501, 'Tela ainda nao implementada: backend.suporte.index');
    }
    ...
    public function show(): never
    {
        // Esqueleto: a rota existe e esta no mapa, a tela ainda nao foi construida.
        // O ambiente Site publico foi implementado primeiro; este entra na sequencia.
        throw new HttpException(501, 'Tela ainda nao implementada: backend.suporte.show');
    }
}
