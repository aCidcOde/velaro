...
## Universal Rule: Mobile First

- Always design mobile-first and make the mobile experience the best version of the product.
- Every navigation must include a mobile menu that is usable with no extra setup.
- Esta regra é universal e não tem exceção neste projeto.
...
## Restrições deste scaffold

Ao aplicar a skill dentro do CodaFácil:

- A stack de UI é **Livewire 4 + Volt + Flux UI + Tailwind v4**. Ver `.claude/skills/tailwind/SKILL.md`.
- Toda tela precisa de paridade dark/light — ver `docs/guidelines/111-agente-darkmode.md`.
- Tokens de marca ficam em `DESIGN.md`; não hardcodar cor/fonte direto no componente.
- Componente CRUD simples é Volt; lógica multi-step é full component em `app/Livewire/`.
